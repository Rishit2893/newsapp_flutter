...
import 'package:newsapp/models/news/article_model.dart';
import 'package:newsapp/pages/article_view.dart';
import 'package:newsapp/pages/category_news.dart';
import 'package:newsapp/pages/weather_home_screen.dart';
      ...
      appBar: AppBar(
        ...
        elevation:0.0,
          actions:[GestureDetector(
            ...
            child: Image.asset("images/icons/clouds.png",height:38),
          )]
      ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          ...
                          child: Text("View All", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w500, fontSize: 16.0) )),
                    ],
                  ),
                ),
      ...
      child: Container(
        ...
        child: Stack(children: [
          ...
          Container(
            ...
            child: Center(
              child:Text(categoryName, style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)),)
          )
        ]),
      ),
    );
