...
import 'package:newsapp/pages/signup_screen.dart';
import 'package:newsapp/utils/color_utils.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    [hexStringToColor("CB2B93"),
      ...
      hexStringToColor("5E61F4")], begin:Alignment.topCenter,end:Alignment.bottomCenter )),
